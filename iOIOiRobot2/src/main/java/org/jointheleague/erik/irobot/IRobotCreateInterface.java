...
public interface IRobotCreateInterface {
     ...
     * <p>
     * A Virtual Wall emits infrared signals that Create sees with its
     * Omnidirectional Infrared Receiver, located on top of the bumper.
     * <p>
     * If you want the Create to home in on a Virtual Wall, cover all but a
     * small opening in the front of the infrared receiver with black electrical
     * tape.
     * <p>
     * Create spins to locate a virtual wall, then drives toward it. Once Create
     * hits the wall or another obstacle, it stops.
     *
     * @see #demo(int)
     */
     ...
     * <ul>
     * <li>No bumper: G major. <br>
     * <li>Right/left bumper: D major 7 <br>
     * <li>Both bumpers (center): C major
     * </ul>
     *
     * @see #demo(int)
     */
    ...
    /**
     * Identifier used to abort a demo. Calling <code>demo(DEMO_ABORT)</code>
     ...
     */
    public static final int SENSORS_GROUP_ID100                             = 100;
     ...
     * SENSORS_STASIS
     */
    public static final int SENSORS_GROUP_ID101                             = 101;
     ...
     * SENSORS_LIGHT_BUMP_SIGNAL_RIGHT<br>
     */
    public static final int SENSORS_GROUP_ID106                             = 106;
     ...
     * SENSORS_STASIS
     */
    public static final int SENSORS_GROUP_ID107                             = 107;
     ...
     */
    public static final int SENSORS_CLIFF_SIGNAL_LEFT                       = 28;
    /**
     * Identifies the Cliff Front Left Signal sensor.
     *
     * @see #getCliffSignalLeftFront()
     */
    public static final int SENSORS_CLIFF_SIGNAL_LEFT_FRONT                 = 29;
    /**
     * Identifies the Cliff Front Right Signal sensor.
     *
     * @see #getCliffFrontRightSignal()
     */
    public static final int SENSORS_CLIFF_SIGNAL_RIGHT_FRONT                = 30;
    /**
     * Identifies the Cliff Right Signal sensor.
     *
     * @see #getCliffSignalRight()
     */
    public static final int SENSORS_CLIFF_SIGNAL_RIGHT                      = 31;
    /**
     ...
     */
    public static final int SENSORS_REQUESTED_VELOCITY_RIGHT                = 41;
    /**
     * Identifies the Requested Left Velocity sensor.
     *
     * @see #getRequestedVelocityLeft()
     */
    public static final int SENSORS_REQUESTED_VELOCITY_LEFT                 = 42;

    /**
     * Identifies the left encoder
     */
    public static final int SENSORS_ENCODER_COUNT_LEFT                      = 43;

    /**
     * Identifies the right encoder
     */
    public static final int SENSORS_ENCODER_COUNT_RIGHT                     = 44;

    /**
     * Identifies the light bumper sensor.
     */
    public static final int SENSORS_LIGHT_BUMPER                            = 45;

    /**
     * Identifies the light bump left signal strength sensor.
     */
    public static final int SENSORS_LIGHT_BUMP_SIGNAL_LEFT                  = 46;

    /**
     * Identifies the light bump front left signal strength sensor.
     */
    public static final int SENSORS_LIGHT_BUMP_SIGNAL_LEFT_FRONT            = 47;

    /**
     * Identifies the light bump center left signal strength sensor.
     */
    public static final int SENSORS_LIGHT_BUMP_SIGNAL_LEFT_CENTER           = 48;

    /**
     * Identifies the light bump center right signal strength sensor.
     */
    public static final int SENSORS_LIGHT_BUMP_SIGNAL_RIGHT_CENTER          = 49;

    /**
     * Identifies the light bump front right signal strength sensor.
     */
    public static final int SENSORS_LIGHT_BUMP_SIGNAL_RIGHT_FRONT           = 50;

    /**
     * Identifies the light bump right signal strength sensor.
     */
    public static final int SENSORS_LIGHT_BUMP_SIGNAL_RIGHT                 = 51;
     ...
     */
    public static final int SENSORS_INFRARED_BYTE_LEFT                      = 52;
    /**
     * Identifies the right infrared sensor.
     *
     * @see #getInfraredByteRight()
     */
    public static final int SENSORS_INFRARED_BYTE_RIGHT                     = 53;

    /**
     * Identifies the left motor current sensor.
     */
    public static final int SENSORS_MOTOR_CURRENT_LEFT                      = 54;

    /**
     * Identifies the right motor current sensor.
     */
    public static final int SENSORS_MOTOR_CURRENT_RIGHT                     = 55;

    /**
     * Identifies the stasis sensor.
     */
    public static final int SENSORS_STASIS                                  = 58;
     ...
     * returned. 0 = 0 volts; 1023 = 5 volts. The analog input is on pin 4.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the Device Detetct / Baud Rate Change pin.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the Cargo Bay Digital Input 0 pin.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the Cargo Bay Digital Input 1 pin.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the Cargo Bay Digital Input 2 pin.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the Cargo Bay Digital Input 3 pin.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the front left cliff sensor.
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the Play button
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
    ...
    /**
     * Gets the state of the caster wheel sensor
     * <p>
     * <b>NOTE:</b> This method returns a locally stored value previously read
     * from the Create. It is the client's responsibility to read the sensor
     * values from the Create prior to calling this method in order to ensure
     ...
     *
     * @param powerLedOn
     *            when true turns Power LED on
     * @param playLedOn
     *            when true turns Play LED on
     * @param advanceLedOn
     *            when true turns Advance LED on
     * @throws ConnectionLostException
     * @throws InterruptedException
     */
     ...
     *
     * @param togglePower
     *            if true toggles the intensity of the Power LED
     * @param togglePlay
     *            if true toggles the on-off state of the Play LED
     * @param toggleAdvance
     *            if true toggles the on-off state of the Advance LED
     * @throws ConnectionLostException
     * @throws InterruptedException
     */
     ...
     *            true turns Low Side Driver 0 on.
     * @param lowSideDriver1On
     *            true turns Low Side Driver 1 on.
     * @param lowSideDriver2On
     *            true turns Side Driver 2 on.
     * @throws ConnectionLostException
     * @throws InterruptedException
     */
    public void lowSideDrivers(boolean lowSideDriver0On, boolean lowSideDriver1On,
     ...
     *
     * @param songNumber
     *            the number of the song the Create is to play.
     * @throws ConnectionLostException
     * @throws InterruptedException
     * @see #song(int, int[])
     ...
     * @throws InterruptedException
     */
    public void pwmLowSideDrivers(int lowSideDriver0DutyCycle, int lowSideDriver1DutyCycle,
     ...
     *
     * @param sensorIds
     *            An array of the SENSORS_* constants.
     * @throws IllegalArgumentException
     *             if the array of sensorIds is too long.
     * @throws ConnectionLostException
     * @throws InterruptedException
     */
     ...
     *
     * @param pin0High
     *            if true sets the output of the first digital output to high
     * @param pin1High
     *            if true sets the output of the second digital output to high
     * @param pin2High
     *            if true sets the output of the third digital output to high
     * @throws ConnectionLostException
     * @throws InterruptedException
     */
    // public void setDigitalOutputs(boolean pin0High, boolean pin1High, boolean
    // pin2High)
    // throws ConnectionLostException;
     ...
     * <p>
     * This is the best method of requesting sensor data if you are controlling
     * the Create over a wireless network (which has poor real-time
     * characteristics) with software running on a remote computer.
     *
     * @param sensorIds
     *            an array of sensor ids as specified by the SENSOR_* constants.
     ...
     *
     * @param playButton
     *            If true wait for the play button, otherwise wait for the
     *            advance button
     * @param beep
     * @throws ConnectionLostException
     * @throws InterruptedException
